...
public class InstagramApp {
    ...
    private InstagramDialog.OAuthDialogListener listener;
    ...
    //tags for the hashmap that stores String data
    ...
    public InstagramApp(Context context, String clientId, String clientSecret,
        ...
        mCtx = context;
        mSession = new InstagramSession(context); //SharedPreferences to store session data
        ...
        listener = new InstagramDialog.OAuthDialogListener() {
            @Override
...
//                    urlConnection.setDoOutput(true);
        ...
        Log.d("INSTAGRAM INFO", "TAG_ID - " + TAG_ID
